 ...
 */
public class MemberPhotoUtil {

    public Animator mCurrentAnimator;
    public int mShortAnimationDuration = AppConstants.SHORT_ANIMATION_DURATION;

    public void zoomImageFromThumb(final ImageView thumbView, View view) {
        ...
        view.findViewById(R.id.container_relative).getGlobalVisibleRect(finalBounds, globalOffset);
